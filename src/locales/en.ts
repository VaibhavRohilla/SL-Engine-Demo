...
export const en = {
  ...
  'hud.board.buyButton': 'Info',
  'hud.board.balanceLabel': 'Balance',
  'hud.board.paytablePanel': 'Info',
  'hud.board.settingsPanel': 'Menu',
  'hud.board.soundPanel': 'Sound',
  'hud.board.visualProof.title': 'Cleopatra',
